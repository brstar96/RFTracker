...
#pragma region 
	...
	viewer->createViewPort(0.0, 0.0, 1.0, 1.0, RunTime_Window);
	viewer->createViewPort(0.0, 0.0, 0.01, 1.0, Info_Window);
...
#pragma endregion 
	...
	while (!viewer->wasStopped())
	{
		...
		{
#pragma region First Segmentation
...
#pragma endregion 
					...
					pcl::copyPointCloud(*Full_Cloud, *A_Full_Cloud);
					pcl::visualization::PointCloudColorHandlerCustom<pcl::PointXYZ> color(A_Full_Cloud, 100, 100, 100);
					viewer->addPointCloud(A_Full_Cloud, color, "A_Full_Cloud", RunTime_Window);
...
#pragma region IPC
		...
		if (IPC && Ready)
		{
			...
			Transmiter->communicate_data(Packet, 48);
		}
