...
import matplotlib #plotting (both interactive and to files)
import matplotlib.pyplot as plt
import seaborn as sns #extra plot types, elegant and readable plot style
from sklearn import data sets
...
print(f'Test data Spearman correlation: {spearman[0]:.3}') #spearman 배열의 첫번째 인자, 즉 Spearman correlation coefficient를 소수점 아래 3자리까지 출력
